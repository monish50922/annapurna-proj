    ...
    <div className="grid min-h-screen lg:grid-cols-2">
      ...
      <div className="hidden lg:flex flex-col justify-center items-center gradient-hero p-12">
        <div className="max-w-md text-center animate-fade-in-up">
          <Heart className="mx-auto h-16 w-16 text-primary-foreground fill-primary-foreground mb-6 animate-float" />
      ...
      <div className="flex items-center justify-center p-6 bg-background">
        <Card className="w-full max-w-md border-0 shadow-none bg-transparent">
          <CardHeader className="text-center">
            <Link to="/" className="mx-auto flex items-center gap-2 font-display text-2xl font-bold text-primary mb-2 lg:hidden">
